...
from drive_state.vendor.models import DriverState, ProcessedFrame
...
STATE_COLORS = {
    ...
    DriverState.ALERT: (76, 190, 118),
    DriverState.MICROSLEEP: (38, 38, 245),
}

# Vendored alongside this module so the overlay brands correctly regardless of
# the working directory the CLI is invoked from.
LOGO_PATHS = (Path(__file__).resolve().parent / "assets" / "logo-overlay.png",)
